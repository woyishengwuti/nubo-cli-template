/**
 * @ Author: feixiang.wu
 * @ Create Time: 2020-12-18 14:16:57
 * @ Modified by: feixiang.wu
 * @ Modified time: 2020-12-18 14:39:09
 * @ Description:
 */

import { shallowMount } from '@vue/test-utils'
import TerList from '@/components/TerminallApp/TerList.vue'

describe('TerList.vue', () => {
  it('renders props.msg when passed', () => {
    const size = 'normal'
    const activedTerId = -1
    const terList = []

    const wrapper = shallowMount(TerList, {
      propsData: { size, activedTerId, terList }
    })
